    ...
    <div style={{ minHeight: '100vh', background: 'var(--rich-black)' }}>
      ...
      <section style={{ position: 'relative', height: '60vh', minHeight: '400px', display: 'flex', alignItems: 'center', padding: '0 5%' }}>
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 0 }}>
          <img src="https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=1200&q=80" alt="Música" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section style={{ padding: '5rem 5%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: 1.8 }}>
            Nuestras clases pueden ser personalizadas o grupales. Desarrolla tu musicalidad con docentes expertos. Para niños (2 a 4 años) aplicamos estimulación temprana e iniciación musical con metodologías lúdicas probadas mundialmente.
          </p>
        </div>
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {[
              "Clases 1 a 1 o ensambles grupales",
              "Estudios insonorizados profesionales",
              "Instrumentos de alta gama disponibles",
              "Presentaciones semestrales en vivo"
            ].map((feature, i) => (
